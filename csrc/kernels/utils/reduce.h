...
template<int Rthreads, typename Engine0, typename Layout0, typename Engine1, typename Layout1, typename Operator>
__device__ inline void allreduce_(cute::Tensor<Engine0, Layout0> &dst, cute::Tensor<Engine1, Layout1> &src, Operator &op) {
    using namespace cute;
    CUTE_STATIC_ASSERT_V(size(dst) == size(src));
    #pragma unroll
    for (int i = 0; i < size(dst); i++){
...
template<int Rthreads, bool zero_init=true, typename Engine0, typename Layout0, typename Engine1, typename Layout1, typename Operator>
...
template<int Rthreads, bool zero_init=true, typename Engine0, typename Layout0, typename Engine1, typename Layout1>
...
template<int Rthreads, typename Engine0, typename Layout0, typename Engine1, typename Layout1>
